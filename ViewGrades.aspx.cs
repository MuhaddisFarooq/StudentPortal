...
public partial class ViewGrades : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query = "SELECT \r\n    C.CourseID,\r\n    C.CourseName,\r\n    CASE \r\n" +
            "        WHEN E.Obtained >= 90 THEN 'A+' \r\n        WHEN E.Obtained BETWEEN 86 AND 89 THEN 'A' \r\n    " +
            "    WHEN E.Obtained BETWEEN 82 AND 85 THEN 'A-' \r\n        WHEN E.Obtained BETWEEN 78 AND 81 THEN 'B+' \r\n " +
            "       WHEN E.Obtained BETWEEN 74 AND 77 THEN 'B' \r\n        WHEN E.Obtained BETWEEN 70 AND 73 THEN 'B-' \r\n " +
            "       WHEN E.Obtained BETWEEN 66 AND 69 THEN 'C+' \r\n        WHEN E.Obtained BETWEEN 62 AND 65 THEN 'C' \r\n  " +
            "      WHEN E.Obtained BETWEEN 58 AND 61 THEN 'C-' \r\n        WHEN E.Obtained BETWEEN 54 AND 57 THEN 'D+' \r\n  " +
            "      WHEN E.Obtained BETWEEN 50 AND 53 THEN 'D' \r\n        ELSE 'F' \r\n    END AS Grade\r\nFROM StudentCourse SC\r\n" +
            "LEFT JOIN Evaluation E ON SC.StudentID = E.StudentID AND SC.CourseID = E.CourseID\r\nJOIN Courses C ON SC.CourseID = C.CourseID\r\nWHERE SC.StudentID = @SID;";
